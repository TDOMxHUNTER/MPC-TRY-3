...
if (projectId) {
  try {
    ...
    console.error('AppKit initialization issue:', error);
    // Additional checks for the MetaMask connection error
    if (error instanceof MetaMaskError) {
      console.error('MetaMask connection issue:', error.message);
    }
  }
}
